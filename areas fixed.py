...
volume = input_a ** 3  # cube = a³
print(f"Volume of the Cube is: {volume:.2f}")
print("____________________________")

# Volume of a Rectangular Prism
print("Volume of a Rectangular Prism: ")
input_l = float(input("Enter the length (l): "))
input_w = float(input("Enter the width (w): "))
input_h = float(input("Enter the height (h): "))
volume = input_l * input_w * input_h  # l × w × h
...
volume = 3.14 * (input_r ** 2) * input_h  # πr²h
...
volume = (1/3) * 3.14 * (input_r ** 2) * input_h  # (1/3)πr²h
...
volume = (4/3) * 3.14 * (input_r ** 3)  # (4/3)πr³
